...
type RestartInfo struct {
	...
	// DesiredToRestartWhenReceivingStopped is true if we need to restart container due to api call
	...
	// DesiredToFullyStopWhenReceivingStopped is true if we are forcing a container to stop due to error,
	...
	//
	// Typically, `DesiredToRestartWhenReceivingStopped` and `DesiredToFullyStopWhenReceivingStopped` are
	...
	// `DesiredToRestartWhenReceivingStopped` to be true, and call Docker api to stop it. Before we
	// receiver the "Stopped" response, an essential of the same task may be stopped, and this container's
	// DesiredToFullyStopWhenReceivingStopped is set to be true. When the "Stopped" message come back,
	// we are not trying to restart it.
